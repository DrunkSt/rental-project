...
var ModalMaker = (function(options) {
  ...
  //types of fieslds
  var fields= [];
  const TYPE_TEXT = 0, TYPE_TEXTAREA = 1, TYPE_IMAGE = 2, TYPE_NUMBER = 3, TYPE_HIDDEN=4, TYPE_SELECT=5, TYPE_HTML_EDITOR=6, TYPE_MULTIPLE_TEXT=7, TYPE_NUMERIC=8, TYPE_LOCATION_MAP=9, TYPE_GROUP_START=10, TYPE_GROUP_END=11, TYPE_LINE_START=12, TYPE_LINE_END=13, TYPE_ICON = 14;
  ...
  **/
  var renderContent = function(element){
    ...
    var modal = modalTemplate(content);
    element.html(modal);
  ...
  * Modal Template
  */
  var modalTemplate = function(content){
  ...
  */
  ...
  var textTemplate = function(field){
    ...
    return '<div class="form-group '+field.classes+'">'+
              '<label for="'+field.id+'">'+field.label+'</label>'+
              '<input type="'+field.inputtype+'" name="'+field.id+'" class="form-control" id="'+field.id+'" placeholder="'+field.placeholder+'">'+field.default+'</input>'+
            '</div>';
  }
